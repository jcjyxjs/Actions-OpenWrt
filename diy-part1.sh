...
# sed -i '$a src-git openwrt https://github.com/openwrt/packages.git' feeds.conf.default
...
sed -i '$a src-git openwrt https://github.com/openwrt/luci' feeds.conf.default
